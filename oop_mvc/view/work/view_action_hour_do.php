    ...
    <div class="panel-body">
        <form method="post" action="<?php echo $form_action; ?>">
            <div class="row">
                ...
                <div class="col-md-9"><input type="number" name="month" class="form-control" min=1 max=12 require></div>
            </div>
            <div class="row">
                <div class="col-md-3">Năm</div>
                <div class="col-md-9"><input type="number" name="year" class="form-control"></div>
            </div>
            <div class="row">
                <div class="col-md-3">Số giờ làm việc</div>
                <div class="col-md-9"><input type="number" name="hour" class="form-control"></div>
            </div>
            <div class="row">
