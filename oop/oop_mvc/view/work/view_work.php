                ...
                <td colspan="8">
                    <ul class="pagination m-auto">
                        ...
                        if ($page > 1 && $number_page > 1) {
                            echo "<li class='page-item'><a class='page-link' href='index.php?controller=work&page=$prev_page&$slug'>Prev</a></li>";
                        }
                        ...
                        if ($page < $number_page && $number_page > 1) {
                            echo "<li class='page-item'><a class='page-link'href='index.php?controller=work&page=$next_page&$slug'>Next</a></li>";
                        } ?>
                    </ul>
                </td>
            </tr>
