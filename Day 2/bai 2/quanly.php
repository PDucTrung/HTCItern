                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form role="form" action="edit.php?action=editdev" method="post">
                                            <div class="modal-body">
                                                <div class="d-flex flex-column gap-3">
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control" placeholder="StaffID" name="staffid" aria-label="StaffID" aria-describedby="basic-addon1" id="editdev_id" readonly />
                                                    </div>
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control" placeholder="Ten" name="ten" aria-label="ten" aria-describedby="basic-addon1" />
                                                    </div>
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($devdata)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#editDevModal' onclick='editDev(<?php echo $row["StaffID"] ?>)'>
                                                    Sửa
                                                </button>
                                                <button type='button' class='btn btn-danger' data-bs-toggle='modal' data-bs-target='#deleteDevModal' onclick='deleteDev(<?php echo $row["StaffID"]; ?>)'>
                                                    Xóa
                                                </button>
                                            </td>
                                        </tr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form role="form" action="edit.php?action=editmanager" method="post">
                                            <div class="modal-body">
                                                <div class="d-flex flex-column gap-3">
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control" placeholder="StaffID" name="staffid" aria-label="StaffID" aria-describedby="basic-addon1" id="editmanager_id" readonly />
                                                    </div>
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control" placeholder="Ten" name="ten" aria-label="ten" aria-describedby="basic-addon1" />
                                                    </div>
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($managerdata)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#editManagerModal' onclick='editManager(<?php echo $row["StaffID"] ?>)'>
                                                    Sửa
                                                </button>
                                                <button type='button' class='btn btn-danger' data-bs-toggle='modal' data-bs-target='#deleteManagerModal' onclick='deleteManager(<?php echo $row["StaffID"] ?>)'>
                                                    Xóa
                                                </button>
                                            </td>
                                        </tr>
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($workdata)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#editWorkModal' onclick='editWork(<?php echo $row["StaffID"] ?>)'>
                                                    Sửa
                                                </button>
                                                <button type='button' class='btn btn-danger btn-del-work' data-bs-toggle='modal' data-bs-target='#deleteWorkModal' onclick='deleteWork(<?php echo $row["StaffID"]; ?>)'>
                                                    Xóa
                                                </button>
                                            </td>
                                        </tr>
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($soefficientsalarydata)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#editSalaryModal' onclick='editSalary(<?php echo $row["StaffID"] ?>)'>
                                                    Sửa
                                                </button>
                                                <button type='button' class='btn btn-danger' data-bs-toggle='modal' data-bs-target='#deleteSalaryModal' onclick='deleteSalary(<?php echo $row["StaffID"] ?>)'>
                                                    Xóa
                                                </button>
                                            </td>
                                        </tr>
