                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($workdata)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#editWorkModal'>
                                                    Sửa
                                                </button>
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($soefficientsalarydata)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#editSalaryModal'>
                                                    Sửa
                                                </button>
