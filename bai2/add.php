        ...
        switch ($_GET["action"]) {
            case 'adddev':
                ...
                if ($staffid == "" || $ten == "" || $tuoi == "" || $diachi == "" || $ngaysinh == "" || $sonamkinhnghiem == "" || $luongcoban == "" || $nnlt == "" || $selectlevel == "") {
                    ...
                    if (mysqli_num_rows(parent::check_id("staff", "*", "StaffID='$staffid'"))  > 0) {
            ...
            case 'addwork':
                ...
                if ($staffid == "" || $sogio == "" || $thang == "" || $nam == "") {
                    ...
                    if (mysqli_num_rows(parent::check_id("work", "*", "StaffID='$staffid'"))  > 0) {
                        echo '<script> alert("ID đã tồn tại"); </script>';
                        echo "<script> window.location = 'quanly.php' </script>";
                    } else {
            ...
            case 'addsalary':
                ...
                if ($staffid == "" || $hsluong == "") {
                    ...
                    if (mysqli_num_rows(parent::check_id("soefficientsalary", "*", "StaffID='$staffid'"))  > 0) {
                        echo '<script> alert("ID đã tồn tại"); </script>';
                        echo "<script> window.location = 'quanly.php' </script>";
                    } else {
